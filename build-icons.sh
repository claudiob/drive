#!/bin/sh
# Every icon this gem shows anywhere is rendered from icon.svg, so the circuit is drawn
...
# mistake.
sed "s/rx='14'/rx='0'/" icon.svg > /tmp/recourse-square.svg

png 180 apple-touch-icon.png /tmp/recourse-square.svg
...
png 1024 avatar.png /tmp/recourse-square.svg
...
for size in 16 32 48; do png "$size" "/tmp/recourse-$size.png" icon.svg; done
magick /tmp/recourse-16.png /tmp/recourse-32.png /tmp/recourse-48.png favicon.ico
