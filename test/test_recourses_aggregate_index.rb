...
class TestRecoursesAggregateIndex < IntegrationCase
  ...
  # be filed under a key that cannot tell one page of twenty rows from another, and the
  # next reader of any such page would be served this one. Proved by moving a figure
  # without moving a row: the page is the same shape and says something new.
